        ...
        <Dialog as="div" className="relative z-10" onClose={closeFunc}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="sm:w-[30rem] transform overflow-hidden rounded-xl bg-gray-50 dark:bg-gray-700 p-6 text-left align-middle shadow-xl transition-all">
                  <div>
                    <div className="absolute top-4 right-4">
                      <button
                        type="button"
                        className="dark:text-gray-200 text-gray-500 hover:text-gray-600 focus:outline-none active:outline-none dark:hover:text-gray-300"
                        onClick={closeFunc}
                      >
                  ...
                  <div className="text-slate-800 dark:text-slate-300 mt-4">
                    <p>
                      {data.about ? `"${data.about}"` : 'About Not Available!'}
                    </p>
                  </div>
