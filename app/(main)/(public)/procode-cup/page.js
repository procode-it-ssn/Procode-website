  ...
  let timeline_data = [
    {
      ...
      description:
        "Get ready for a wonderful journey. Choose your problem statements!",
    },
    {
    ...
    },
    {
      ...
      description:
        "The final showdown where top teams compete for the ProCoDe Cup",
    },
  ];
  ...
  const problem_statements = [
    {
      ...
      problem_statement:
        "Develop a React-based dashboard that allows users to explore technology trends, visualize GitHub activity, and receive AI-driven investment recommendations based on ML models analyzing repository activity.",
      domain: "Finance - ML, ReactJS",
    },
    {
      title: "Expense Splitter",
      problem_statement:
        "Develop an application that allows users to split expenses and track shared spending with friends, family, or groups. Users should be able to assign participants, track who owes whom, and settle debts easily.",
      domain: "Finance",
    },
    {
      title: "Expense Tracker",
      problem_statement:
        "Develop an expense tracking application where users can log daily expenses, categorize spending, and view insights such as monthly expenditure breakdowns and trends. Bonus: Implement a chatbot for querying spending patterns.",
      domain: "Finance",
    },
    {
      title: "Subscription Manager",
      problem_statement:
        "Develop an application that allows users to track their subscriptions across various services (e.g., Netflix, Spotify) and categorize them by type. The system should provide renewal reminders and spending insights.",
      domain: "Finance",
    },
    {
      title: "Workout Planner",
      problem_statement:
        "Develop a mobile or web application that allows users to create and manage their workout routines, log progress, and track performance over time.",
      domain: "Healthcare and Well Being",
    },
    {
      title: "Medication Reminder",
      problem_statement:
        "Develop an application that helps users track their medications and set reminders to take them on time, maintaining a history of doses taken or skipped.",
      domain: "Healthcare and Well Being",
    },
    {
      title: "Hospital Queue Management",
      problem_statement:
        "Develop a queue management system for hospitals or clinics, allowing patients to register, receive a queue number, and track their position in real time.",
      domain: "Healthcare and Well Being",
    },
    {
      title: "Rare Disease Support Network",
      problem_statement:
        "Develop a community-driven application where individuals with rare diseases can connect, share experiences, and support each other.",
      domain: "Healthcare and Well Being",
    },
    {
      title: "News Verification System",
      problem_statement:
        "Develop a news verification system that enables users to collaboratively validate the accuracy of news articles, displaying a credibility score and tracking verification history.",
      domain:
        "Social Good & Accessibility - ReactJS, Flutter, Git Version Control",
    },
    {
      title: "Disaster Relief Connector",
      problem_statement:
        "Develop an application that connects people offering and requesting help during disasters, providing a location-based filtering system for quick assistance.",
      domain: "Social Good & Accessibility",
    },
    {
      title: "Volunteer Matchmaking",
      problem_statement:
        "Develop an application that connects volunteers with community service activities like beach cleanups, tree plantations, and social outreach programs.",
      domain: "Social Good & Accessibility",
    },
    {
      title: "Lost and Found Portal",
      problem_statement:
        "Develop an application where users can report lost or found items, upload descriptions and images, and contact others for recovery.",
      domain: "Social Good & Accessibility",
    },
    {
      title: "AI Tutoring System",
      problem_statement:
        "Develop an AI-driven tutoring system that adapts to students' learning progress, providing personalized exercises and interactive problem-solving modules.",
      domain: "Education - AI, ReactJS, Flutter, Git Version Control",
    },
    {
      title: "Outpass Management System",
      problem_statement:
        "Develop an application that allows students to apply for an outpass electronically, enabling teachers to review and approve requests online, with a QR-based verification system.",
      domain: "Education",
    },
    {
      title: "College Chatbot",
      problem_statement:
        "Develop a chatbot that provides instant access to information about SSN College, including admissions, courses, events, and policies.",
      domain: "Education",
    },
  ];
  ...
  const project_guidelines = [
    {
      ...
      description:
        "All projects must include the following (including open innovation):",
      rules: [
        {
          bold: "Frontend",
        ...
        {project_guidelines.map((guideline, index) => {
          return (
            <div className="my-5" key={index}>
              ...
              <h2 className="my-2">{guideline.description}</h2>

              <ul className="list-disc list-inside space-y-1">
                {guideline.rules.map((rule) => (
                  <li key={index}>
                    <b className="sm:text-md">{rule.bold}: </b>
                    {rule.text}
                  </li>
                ))}
              </ul>
